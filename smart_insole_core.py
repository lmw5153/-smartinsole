...
def render_video(left_track, right_track, out_mp4: str | Path, cfg: RenderConfig):
...
def analyze_and_render(left_df: pd.DataFrame, right_df: pd.DataFrame, cfg: RenderConfig | None = None) -> Dict[str, Any]:
    ...
    frames, duration, out_path = render_video(left_track, right_track, out_mp4, cfg)
